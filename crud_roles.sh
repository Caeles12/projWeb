...
post http://localhost:3000/users 201 "firstname=John&lastname=Doe&age=23&password=Hello12"
post http://localhost:3000/users 201 "firstname=Janette&lastname=Doe&age=32&password=Hello12"
